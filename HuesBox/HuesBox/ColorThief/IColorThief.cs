...
namespace ColorThiefDotNet
{
    public interface IColorThief
    {
        ...
        /// <returns></returns>
        Task<QuantizedColor> GetColor(ImageSource sourceImage, int quality = 10, bool ignoreWhite = true);
        ...
        /// <returns></returns>
        /// <code>true</code>
        Task<List<QuantizedColor>> GetPalette(ImageSource sourceImage, int colorCount = 5, int quality = 10,
